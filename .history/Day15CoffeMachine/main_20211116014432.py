...
def evalAmt(drink, totAmt):
    if MENU[drink]["cost"] <= totAmt:#latte and MENU[drink]['ingredients']['water'] < resources['water'] and MENU[drink]['ingredients']['milk'] < resources['milk'] and MENU[drink]['ingredients']['coffee'] < resources['coffee']:
        return True
    else:
        return False
